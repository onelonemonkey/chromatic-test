...
${g}`);}}),t.on(N,z),t.on(U,()=>n.then(u=>u.removeAddon(w)).catch(u=>console.error(u)));let p=m.subscribe(R,t),c=m.subscribe(k,t),f=m.subscribe(B,t);return ie(5e3,u=>{f.value=void 0,c.value=u;},u=>{f.value=u;}),se(e,async u=>{d&&(p.value=await ne(u,r));}),setInterval(()=>t.emit(`${a}/heartbeat`),1e3),t}var ue={managerEntries:oe,experimental_serverChannel:ae,env:async(t,{configType:r})=>r==="PRODUCTION"?t:{...t,CHROMATIC_BASE_URL:E}},Ge=ue;
